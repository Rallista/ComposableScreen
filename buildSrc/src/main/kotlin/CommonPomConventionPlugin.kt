    ...
    override fun apply(project: Project) {
        project.afterEvaluate {
            ...
            publishing?.publications?.withType(MavenPublication::class.java)?.configureEach {
                pom {
                    url.set("https://github.com/Rallista/ComposableScreen")
                    ...
                    scm {
                        connection.set("scm:git:https://github.com/Rallista/ComposableScreen.git")
                        developerConnection.set("scm:git:ssh://github.com/Rallista/ComposableScreen.git")
                        url.set("https://github.com/Rallista/ComposableScreen")
                    }
